...
class Genesis {
	...
	public function add_widget_class( $params ) {
		...
		if ( false === strpos( $params[0]['widget_id'], 'agt_subscribe' ) && false === strpos( $params[0]['widget_id'], 'agrilife_livewhale' ) ) {
	...
	public function post_meta_footer() {
		...
		if ( ! empty( get_the_author_meta( 'description' ) ) ) {
			...
			$author_biography = sprintf(
				'<!--googleoff: index--><div class="subheader p cell collapse small-12"><small>%s</small></div><!--googleoff: index-->',
