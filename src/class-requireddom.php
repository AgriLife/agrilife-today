 ...
 *
 * @link       https://github.com/AgriLife/agrilife-today/blob/master/src/class-requireddom.php
 * @since      0.1.1
...
class RequiredDOM {
	...
	public static function render_tamus_logo() {
		...
		$output = '<div class="footer-container-tamus"><a href="http://tamus.edu/" title="Texas A&amp;M University System"><img class="footer-tamus" src="' . AGTODAY_THEME_DIRURL . '/images/footer-tamus-maroon.png" alt="Texas A&amp;M University System Member" /></a></div>';
